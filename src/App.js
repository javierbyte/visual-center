...
const App = React.createClass({
  ...
  render() {
    ...
    const recommendations = _.compact([
      resultLeft > 0.5 && <span>move it left by <b>{toPercent(resultLeft - 0.5)}%</b></span>,
      resultLeft < 0.5 && <span>move it right by <b>{toPercent(1 - resultLeft - 0.5)}%</b></span>,
      resultLeft !== 0.5 && resultTop !== 0.5 && <span> and </span>,
      resultTop > 0.5 && <span>move it up by <b>{toPercent(resultTop - 0.5)}%</b></span>,
      resultTop < 0.5 && <span>move it down by <b>{toPercent(1 - resultTop - 0.5)}%</b></span>
    ]);
      ...
      <div className="app" style={{ backgroundColor: bgColorCodeDark, color: isDark ? '#fff' : '#333' }}>
        ...
        <div className={`demo-image-comparison ${showGuides ? '-show-guides' : ''} ${useCircle ? '-use-circle' : ''}`}>
          <div className="column">
            ...
            <div className="demo-image-container" style={{ backgroundColor: bgColorCode }}>
              <img src={base64} className="demo-image" />
            </div>
          </div>
        ...
        {base64 &&
          <div className="padding-2 results">
            ...
            <div>
              ...
              plugins?
              {' '}
              <a href="http://eepurl.com/b5_E-j" target="_blank"><strong>Join the newsletter!</strong></a>
            </div>
          </div>}
        ...
        <div className="credits padding-2">
          <div>
            More experiments:
            {' '}
            <a href="http://javier.xyz/img2css"><b>img2css</b> (convert images to pure css)</a>
            ,
            {' '}
            <a href="http://javier.xyz/cohesive-colors"><b>cohesive-colors</b> (creates cohesive color palletes)</a>
            ,
            {' '}
            <a href="http://javier.xyz/morphin"><b>morphin</b> (css image morphing)</a>
            ,
            {' '}
            <a href="http://javier.xyz/clashjs/"><b>clashjs</b> (js ai battle game)</a>
            .
          </div>
          <br />
          <div>
            Created by
            {' '}
            <a href="http://javier.xyz/"><b>javierbyte</b></a>
            . (Thanks
            {' '}
            <a href="http://skycatch.com">Skycatch</a>
            {' '}
            for letting me use our logo).
          </div>
        </div>
      </div>
    );
